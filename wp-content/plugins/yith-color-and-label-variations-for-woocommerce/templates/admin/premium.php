		...
		<div class="landing-container">
			<div class="premium-cta">
				<p>
					...
					echo sprintf( esc_html__( 'Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Color and Label Variations%2$s to benefit from all features!', 'yith-color-and-label-variations-for-woocommerce' ), '<span class="highlight">', '</span>' );
					?>
				</p>
		...
		<div class="landing-container">
			...
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used to add html tags.
					echo sprintf( esc_html__( 'How many times did you have to deal with the handling of a %1$stwo-colored%2$s t-shirt and the decision of how to set its color or with the use of a label because the color didn’t satisfy your needs? %3$s Now things have changed! You could select up to two colors for each attribute and create the right matches for the products of your shop.', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>', '<br>' );
					?>
				</p>
				<p>
					<?php
					// translators: placeholders are used to add html tags.
					echo sprintf( esc_html__( 'You could select up to two colors for each attribute and %1$screate the right matches%2$s for the products of your shop.', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>', '<br>' );
					?>
				</p>
			</div>
		</div>
		...
		<div class="landing-container">
			...
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used to add html tags.
					echo sprintf( esc_html__( 'Show the attribute description in product page and %1$sgive users as many information as possible%2$s in order to clear their doubts.', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>' );
					?>
				</p>
			</div>
		</div>
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used to add html tags.
					echo sprintf( esc_html__( 'All the %1$svariations%2$s configured on products will be shown in "Shop" page too: users will have a complete overview about your e-commerce. ', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">
		...
		<div class="landing-container">
			...
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used to add html tags.
					echo sprintf( esc_html__( 'Now your wishes come true: by %1$schoosing the variation and hovering your mouse over it%2$s, the product image will dynamically turn into the variation image. %3$sA dedicated option will allow enabling or disabling this feature.', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>', '<br>' );
					?>
				</p>
			</div>
		</div>
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used to add html tags.
					echo sprintf( esc_html__( 'Enhance the WooCommerce "Additional Information" tab in product page by showing the complete %1$slist of the attributes%2$s associated with the product.', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used to add html tags.
					echo sprintf( esc_html__( 'Every variation will be displayed as a separate product. For example if you offer a sweater in 3 different colors, you will see the same sweater displayed 3 times, in every color.', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">
